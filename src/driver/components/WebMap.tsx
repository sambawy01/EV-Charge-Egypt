  ...
  return '<div style="background:#141B2D;color:#F0F4FF;padding:14px;border-radius:12px;min-width:280px;max-width:320px;font-family:system-ui,-apple-system,sans-serif;">' +
    ...
    '<div style="margin-bottom:10px;">' +
      ...
      '<div style="display:flex;gap:6px;">' +
        '<button onclick="window.parent.postMessage({type:\\'statusReport\\',stationId:\\''+s.id+'\\',status:\\'available\\'},\\'*\\')" style="flex:1;padding:6px 0;border-radius:8px;border:1px solid #00FF88;background:#00FF8815;color:#00FF88;font-size:10px;font-weight:700;cursor:pointer;">✅ Open</button>' +
