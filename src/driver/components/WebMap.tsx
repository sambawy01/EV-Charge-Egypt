  ...
  return '<div style="background:#141B2D;color:#F0F4FF;padding:14px;border-radius:12px;min-width:280px;max-width:320px;font-family:system-ui,-apple-system,sans-serif;">' +
    ...
    '<div style="margin-bottom:10px;">' +
      ...
      '<div style="display:flex;gap:6px;">' +
        '<button onclick="window.parent.postMessage({type:\\'statusReport\\',stationId:\\''+s.id+'\\',status:\\'available\\'},\\'*\\')" style="flex:1;padding:6px 0;border-radius:8px;border:1px solid #00FF88;background:#00FF8815;color:#00FF88;font-size:10px;font-weight:700;cursor:pointer;">✅ Available</button>' +
        '<button onclick="window.parent.postMessage({type:\\'statusReport\\',stationId:\\''+s.id+'\\',status:\\'partially_available\\'},\\'*\\')" style="flex:1;padding:6px 0;border-radius:8px;border:1px solid #FFB020;background:#FFB02015;color:#FFB020;font-size:10px;font-weight:700;cursor:pointer;">🟡 Some</button>' +
        '<button onclick="window.parent.postMessage({type:\\'statusReport\\',stationId:\\''+s.id+'\\',status:\\'busy\\'},\\'*\\')" style="flex:1;padding:6px 0;border-radius:8px;border:1px solid #FF4D6A;background:#FF4D6A15;color:#FF4D6A;font-size:10px;font-weight:700;cursor:pointer;">🔴 Busy</button>' +
        '<button onclick="window.parent.postMessage({type:\\'statusReport\\',stationId:\\''+s.id+'\\',status:\\'out_of_service\\'},\\'*\\')" style="flex:1;padding:6px 0;border-radius:8px;border:1px solid #FF4D6A;background:#FF4D6A15;color:#FF4D6A;font-size:10px;font-weight:700;cursor:pointer;">⚠️</button>' +
      '</div>' +
    '</div>' +
    // Action buttons row
